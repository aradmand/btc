...
order_id = '8c9ba6b9-c0e6-4f13-bb05-98611dcd7994'
puts 'List of fills on coinbase exchange:'
fills = coinbase_exchange_client.fills(order_id)
puts fills

puts 'Total filled size:'
filled_size = coinbase_exchange_client.calculate_total_filled_size(fills)
puts filled_size
